...
echo "Enter the absolute path to the genesis.txn file (the default assumes you are using Vagrant, and will use /home/vagrant/vcx-vagrant/config/genesis.txn"
read -p ':' genesispath
echo $genesispath
...
then
      ...
      genesispath="/home/vagrant/vcx-vagrant/config/genesis.txn"
