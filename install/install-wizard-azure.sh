...
echo "Enter the absolute path to the genesis.txn file (the default assumes you are using Vagrant, and will use /home/azureuser/config/genesis.txn"
read -p ':' genesispath
echo $genesispath
...
if [ -z "$genesispath" ]
then
      echo "\$genesispath is empty, using default value of /home/azureuser/config/genesis.txn"
      genesispath="/home/azureuser/config/genesis.txn"
...
if [  -d "/home/azureuser/.indy_client/wallet" ]; then
...
sudo cp VCXWebApp.service /etc/systemd/system/VCXWebApp.service &&
sudo systemctl start VCXWebApp.service &&
# install and config nginx
yes | sudo apt-get install nginx &&
# clean /var/www
sudo rm -Rf /var/www/html/* &&
# symlink /var/www => /home/azureuser/web
sudo ln -s /home/azureuser/web/* /var/www/html &&
